...
public class DNADomainsFreeGrid {
    ...
    static DataStack digitizedDataStack = GenerateFreegridDNA.digitizedDataStack;

    static ArrayList<Domains> xyDomainList = GenerateFreegridDNA.xyDomainList;
    DNASequenceGenerator dnaSequenceGenerator;
    int i,j;
    int entry;
    public DNADomainsFreeGrid(){
        checkAll();
    }
    public DNADomainsFreeGrid(int i, int j, int e) {
        entry=e;
